...
**Projet :** RESTAURANT FADAE RIF — **https://www.fadaerif.space/**
...
|---|---|---|---|
| `SUPABASE_URL` | ✅ Oui | URL complète du projet Supabase (sans chemin) | `https://hmglnevnhzdewbohadil.supabase.co` |
...
| **Projet actuel** | RESTAURANT FADAE RIF (https://www.fadaerif.space/) |
